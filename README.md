...
`WhatsOnMyDeskSetup-x64.exe`를 실행한다. WebView2 Evergreen Runtime이 필요하다. 설치 프로그램은 현재 사용자 범위에 설치하며 관리자 권한을 요구하지 않는다.
...
출력: `release/WhatsOnMyDeskSetup-x64.exe`, `release/WhatsOnMyDesk-portable-x64.zip`, `release/SHA256SUMS.txt`.
