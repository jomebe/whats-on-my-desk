...
function LandingPage() {
  return <main className="landing"><section className="landing-hero"><p className="eyebrow">WINDOWS LIVE WALLPAPER</p><h1>What’s on<br/>My Desk?</h1><p className="landing-copy">A living desktop that changes with devices connected to your PC.</p><div className="landing-actions"><a href="https://github.com/jomebe/whats-on-my-desk/releases/download/v0.1.0-alpha.1/WhatsOnMyDeskSetup-x64.exe">Download for Windows</a><a className="quiet-link" href="https://github.com/jomebe/whats-on-my-desk">View on GitHub</a></div></section><section className="landing-scene"><div className="landing-monitor"><i /></div><div className="landing-tower" /><div className="landing-keyboard" /><div className="landing-mouse" /><div className="landing-plant"><i/><i/><i/></div></section><section className="landing-features"><article><b>Your setup, alive</b><span>Devices appear and disappear in real time.</span></article><article><b>Interactive when you need it</b><span>Press Ctrl + Alt + D to explore your desk.</span></article><article><b>Private and local</b><span>Device data stays on your PC. No account, no analytics.</span></article></section></main>;
}
