...
export function DeviceIllustration({ category }: { category: DeviceCategory }) {
  ...
  if (category === "headset") return <svg viewBox="0 0 120 145" {...common}><path d="M18 67V55a42 42 0 0184 0v12"/><rect x="10" y="62" width="22" height="39" rx="9"/><rect x="88" y="62" width="22" height="39" rx="9"/><path d="M99 100c0 10-8 12-21 12M60 92v34M38 129h44"/><path d="M47 126h26"/></svg>;
